<%@ Page Title="ABS:: NIID" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="niid.aspx.cs" Inherits="ABSGeneral.Web.niid" %>
    ...
    <div class="container">
        <div class="row bg-danger" style="-ms-border-radius: 5px !important; border-radius: 0 0 5px 5px !important; top: 0 !important;">
            <div class="col-lg-12" style="padding: 15px;">
                <img src="Content/images/cp1.fw.png" align="left" style="height: 90px;" />
            ...
            <div class="col-md-10 form-group-sm">
                <div class="form-inline">
                    ...
                    <asp:DropDownList CssClass="form-control" ID="filterDdw" runat="server" Style="width: 150px !important;">
                        ...
                        <asp:ListItem Value="4">Successful</asp:ListItem>
                        <asp:ListItem Value="5">Failed</asp:ListItem>
                    </asp:DropDownList>
                    ...
                    <asp:TextBox ID="txtStartDate" placeholder="Start Date" class="form-control small textInputMini1" runat="server" Width="100px"></asp:TextBox>
                    <asp:TextBox ID="txtEndDate" placeholder="End Date" class="form-control small textInputMini1" runat="server" Width="100px"></asp:TextBox>
                ...
                <ContentTemplate>
                    <asp:GridView ID="GridView1" runat="server" CaptionAlign="Left" CellPadding="10" ForeColor="#333333" GridLines="None" Width="100%" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Ins. Name" DataField="NIID_InsuredName" />
                            <asp:BoundField HeaderText="Veh. Reg." DataField="NIID_RegistrationNo" />
                            ...
                            <asp:BoundField HeaderText="Upd. Status" DataField="NIID_ReturnMessage" />
                            <asp:BoundField HeaderText="St" DataField="NIID_Status" />
                            <asp:BoundField HeaderText="Upl. Date" DataField="NIID_UploadDate" DataFormatString="{0:dd/MM/yyyy}" ItemStyle-CssClass="marginItem" HeaderStyle-CssClass="marginItem" />
                        </Columns>
